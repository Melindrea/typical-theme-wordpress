...
/** Replaces @mentions with twitter link, from http://bradsknutson.com/blog/automatically-replace-twitter-username-with-link-wordpress/ */
function twitter_replace($content) {
	$twitter_replace = preg_replace('/([^a-zA-Z0-9-_&])@([0-9a-zA-Z_]+)/',"$1<a href=\"http://twitter.com/$2\" target=\"_blank\" rel=\"nofollow\">@$2</a>",$content);
